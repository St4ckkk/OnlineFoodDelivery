...
<body>
                    ...
                    <form action="partials/_manageReviews.php" method="POST">
                        <div class="form-group">
                            ...
                            <div class="rating-stars">
                                ...
                                <label for="star" class="star"><i class="fas fa-star"></i></label>
    ...
    <?php } else {
        ...
        <div class="alert alert-info my-3">
            <font style="font-size:22px"><center>Make a review? You need to <strong><a class="alert-link" data-toggle="modal" data-target="#loginModal"> Login</a></strong></center></font>
        </div></div>';
    }
    ?>
