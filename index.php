      ...
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown mb-0"><span class="txt-slide">Savor The Sweet Moments With Ice Cream!</span></h2>
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown mb-0"><span class="txt-slide">Satisfy Your Cravings With Delicious Filipino Street Foods!</span></h2>
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown mb-0"><span class="txt-slide">Experience The Best Of Fast Food Delights!</span></h2>
              ...
              <div class="carousel-inner">
                ...
                if (mysqli_num_rows($result) > 0) {
                  while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo '<p class="card-subtitle mb-2 text-muted">' . $ratingStars . '</p>';
