...
echo '<nav class="navbar navbar-expand-lg navbar-dark navBg">
<a class="navbar-brand mb-1 mt-1" href="index.php">
<img src="/OnlineFoodDelivery/img/cooking.png" alt="Company Logo" class="company-logo">
<span class="company-name ml-2">' . $systemName . '</span>
</a>
...
echo '<a href="viewCart.php">
        <button type="button" class="btn" title="MyCart">
          <svg xmlns="img/cart.svg" width="16" height="15" fill="currentColor" class="bi bi-cart cart " viewBox="0 0 16 16">
            ...
            <span id="textBtn"><span id="count"> (' . $count . ')</span>
            </svg>  
        </button></a>';
